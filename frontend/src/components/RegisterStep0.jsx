  ...
  return (
    <>
      <div className="text-white flex flex-col gap-[3rem] items-center justify-center w-screen h-screen">
        <h1 className="text-[3rem] font-bold"><span className="text-[#7FB6FF]">Create an account</span> to get started.</h1>
        ...
        <div className="flex flex-col gap-[1.5rem] w-[33%] items-center justify-center">
          ...
          <div>
            ...
            <Link to="/login" className="text-white underline underline-offset-2 hover:text-white/80 transition-all duration-300 ease-in-out">Log in here.</Link>
          </div>
        </div>
      </div>
    </>
